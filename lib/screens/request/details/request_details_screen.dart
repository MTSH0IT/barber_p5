...
import 'package:halake_barber/screens/request/details/complete_booking_sheet.dart';
import 'package:halake_barber/screens/request/details/request_details_controller.dart';
...
class RequestDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    RequestDetailsController requestDetailsController = Get.put(
      RequestDetailsController(),
    );
    return GetBuilder(
      init: requestDetailsController,
      builder: (controller) {
        RequestDetails? requestDetails = controller.requestDetails;
        return Scaffold(
          body: Column(
            children: [
              Container(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      AppRes.convertTimeForService(
                                        int.parse(
                                          requestDetails?.data?.duration ?? '0',
                                        ),
                                      ),
                                      style: kLightWhiteTextStyle.copyWith(
                                        color: ColorRes.themeColor,
              ...
              requestDetails == null
                  ? const Expanded(
                    child: Center(child: LoadingData(color: ColorRes.white)),
                  )
                  : Expanded(
                    child: Column(
                      children: [
                              ...
                              children: [
                                Container(
                                  ...
                                  color: AppRes.getColorByStatus(
                                    requestDetails.data?.status?.toInt() ?? 0,
                                  ),
                                  child: Text(
                                    ...
                                    style: kRegularTextStyle.copyWith(
                                      color: AppRes.getTextColorByStatus(
                                        requestDetails.data?.status?.toInt() ??
                                            0,
                                      ),
                                      fontSize: 14,
                                    ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      BookingAddressWidget(
                                        addressData:
                                            requestDetails.data?.serviceAddress,
                                        serviceLocationType:
                                            requestDetails.data?.serviceLocation
                                                ?.toInt() ??
                                            0,
                                      ),
                                      Visibility(
                                        visible:
                                            requestDetails.data?.staff != null,
                                        child: Padding(
                                          padding: const EdgeInsets.only(
                                            left: 15,
                                            right: 15,
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              AppRes.getPaymentType(
                                                requestDetails.data?.paymentType
                                                    ?.toInt(),
                                              ),
                                ...
                                Visibility(
                                  visible:
                                      requestDetails.data?.isRated?.toInt() ==
                                      1,
                                  child: Container(
                                    width: double.infinity,
                                    decoration: const BoxDecoration(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: CustomCircularInkWell(
                                        onTap: controller.rejectBooking,
                                        child: Container(
...
class AcceptBottomSheet extends StatelessWidget {
  const AcceptBottomSheet({super.key, this.addressData, required this.onClick});
            ...
            child: CustomCircularInkWell(
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: kRegularThemeTextStyle.copyWith(color: ColorRes.white),
                ),
              ),
            ),
          ),
                          ...
                          CustomCircularInkWell(
                            onTap: () async {
                              ...
                              if (Platform.isAndroid) {
                                ...
                                if (await url.canLaunchUrl(
                                  Uri.parse(googleUrl),
                                )) {
                                  await url.launchUrl(Uri.parse(googleUrl));
                                } else {
                                  throw 'Could not launch $googleUrl';
                                }
                              } else {
                                if (await url.canLaunchUrl(Uri.parse(iosUrl))) {
                                  await url.launchUrl(Uri.parse(iosUrl));
                                } else {
