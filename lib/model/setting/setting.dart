import 'package:halake_barber/model/cat/categories.dart';
...
class SettingData {
  SettingData({
    ...
    String? currency,
    num? comission,
    num? maxMinusBalanceForPostPayOption,
    ...
    String? sslcommerzStorePassword,
    ...
    _maxMinusBalanceForPostPayOption = maxMinusBalanceForPostPayOption;
    ...
    _sslcommerzStorePassword = sslcommerzStorePassword;
  ...
  SettingData.fromJson(dynamic json) {
    ...
    _maxMinusBalanceForPostPayOption =
        json['max_minus_balance_for_postpay_option'];
    ...
    _sslcommerzStorePassword = json['sslcommerz_store_passwd'];
  ...
  String? _currency;
  num? _comission;
  num? _maxMinusBalanceForPostPayOption;
  ...
  String? _sslcommerzStorePassword;
    ...
    List<CategoryData>? categories,
      ...
      SettingData(
        ...
        maxMinusBalanceForPostPayOption:
            maxMinusBalanceForPostPayOption ?? _maxMinusBalanceForPostPayOption,
        ...
        sslcommerzStoreId: sslcommerzStoreId ?? _sslcommerzStoreId,
        sslcommerzStorePassword:
            sslcommerzStorePassword ?? _sslcommerzStorePassword,
        sslcommerzCurrencyCode:
            sslcommerzCurrencyCode ?? _sslcommerzCurrencyCode,
  ...
  num? get maxMinusBalanceForPostPayOption => _maxMinusBalanceForPostPayOption;
  ...
  String? get sslcommerzStorePassword => _sslcommerzStorePassword;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['max_minus_balance_for_postpay_option'] =
        _maxMinusBalanceForPostPayOption;
    ...
    map['sslcommerz_store_passwd'] = _sslcommerzStorePassword;
